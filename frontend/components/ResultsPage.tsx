      ...
      <section className="results-hero">
        <div className="results-shell">
          ...
          <div className="results-title-row">
            <div><span className="eyebrow">UWAZI WA MKWANJABET</span><h1>Matokeo Yetu</h1><p>Kila pick hubaki wazi baada ya mechi. Tazama ushindi, hasara, void na picks zinazosubiri bila kuficha chochote.</p></div>
      ...
      <section className="results-content">
        <div className="results-shell">
          ...
          <section className="results-transparency">
            ...
            <div><span>i</span><h3>Utabiri, si dhamana</h3><p>MkwanjaBet hutoa uchambuzi wa michezo. Hakuna pick yenye uhakika wa asilimia 100.</p></div>
          </section>
        </div>
      </section>
    </main>
