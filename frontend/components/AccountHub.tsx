...
export default function AccountHub({initial="wallet"}:{initial?:View}){
 ...
 const [view,setView]=useState<View>(initial); const [betGroup,setBetGroup]=useState<"Open"|"Settled"|"Virtuals">("Open"); const [hideLost,setHideLost]=useState(false); const [balanceHidden,setBalanceHidden]=useState(false); const [method,setMethod]=useState("M-Pesa"); const [amount,setAmount]=useState("10000"); const [depositPhone,setDepositPhone]=useState(""); const [pendingBooking,setPendingBooking]=useState(""); const [pendingStake,setPendingStake]=useState(0); const [expanded,setExpanded]=useState<string|null>(null); const [notice,setNotice]=useState(""); const [realBets,setRealBets]=useState<Bet[]|null>(null); const [betsNotice,setBetsNotice]=useState("Loading your tickets...");
