...
export default function SportsHub({initialTab="prematch"}:{initialTab?:"prematch"|"live"}={}){
  ...
  return <main className="sports-shell">
    ...
    <header className="sports-topbar">
      <Link className="sports-brand" href="/"><img src="/brand/logos/02-primary-logo-light.svg" alt="MkwanjaBet"/><span className="sr-only">MkwanjaBet</span></Link>
    ...
    {mobileSlip&&<div className="mobile-slip-wrap"><div className="mobile-slip-scrim" onClick={()=>setMobileSlip(false)}/><BetSlip mobile/></div>}    <footer className="sports-footer">
      <div><Link className="sports-brand" href="/"><img src="/brand/logos/02-primary-logo-light.svg" alt="MkwanjaBet"/><span className="sr-only">MkwanjaBet</span></Link><p>Secure, wallet-backed sports betting built for Tanzania.</p></div>
