    ...
    <main className="picks-page">
      ...
      <section className="picks-content">
        <div className="picks-shell">
          ...
          <section className="responsible-note"><span>i</span><div><b>Cheza kwa uwajibikaji</b><p>PrimeOdds hutoa uchambuzi na mapendekezo pekee. Hakuna pick yenye uhakika wa asilimia 100.</p></div><Link href="/responsible-play">Soma zaidi →</Link></section>
        </div>
      </section>
    </main>
  );
