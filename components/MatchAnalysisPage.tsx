      ...
      <section className="analysis-body">
        <div className="analysis-shell analysis-grid">
          <div className="analysis-main">
            <article className="prime-recommendation">
              ...
              <div className="confidence-breakdown">
                <div className="confidence-score"><div className="mini-ring"><b>91%</b></div><span><b>Uhakika Mkubwa</b><small>Kiwango cha PrimeOdds</small></span></div>
          ...
          <aside className="analysis-side">
            ...
            <article className="side-card premium-upsell"><span>PRIMEODDS PREMIUM</span><h3>Pata picks zote za Premium</h3><p>Fungua uchambuzi kamili, accumulator za kila siku na arifa za haraka.</p><button className="btn btn-gold">Fungua Premium</button></article>
