...
<nav class="site-nav">
<a aria-label="PrimeOdds home" class="brand" href="#top"><span class="brand-mark">P</span><span>Prime<span>Odds</span></span></a>
...
<div class="phone">
<div class="phone-top"><div class="mini-brand"><span class="brand-mark small">P</span><div><b>PrimeOdds</b><small>Uchambuzi wa mechi</small></div></div><button>⌁</button></div>
...
<div class="ticker"><div><span>PREMIER LEAGUE</span><i></i><span>CHAMPIONS LEAGUE</span><i></i><span>LA LIGA</span><i></i><span>SERIE A</span><i></i><span>BUNDESLIGA</span><i></i><span>PRIMEODDS</span><i></i><span>PREMIER LEAGUE</span><i></i><span>CHAMPIONS LEAGUE</span></div></div>
...
<div class="results-copy reveal"><span class="eyebrow">USHAHIDI, SI AHADI</span><h2>Matokeo unayoweza kuyathibitisha.</h2><p>Kila pick hubaki wazi baada ya mechi kuanza. Zilizoshinda, zilizopotea na void huwekwa wazi ili uipime PrimeOdds kwa matokeo halisi.</p><a class="text-link" href="/results">Angalia matokeo yote <span>→</span></a></div>
...
<section class="section final-cta"><div class="shell reveal"><span class="brand-mark large">P</span><h2>Pick yako inayofuata<br/>inaanzia hapa.</h2><p>Jiunge PrimeOdds and experience football predictions with clarity, confidence and premium design.</p><a class="btn btn-gold" href="/picks">Angalia Picks za Leo →</a></div></section>
</main>
<footer><div class="shell footer-grid"><div><a class="brand" href="#top"><span class="brand-mark">P</span><span>Prime<span>Odds</span></span></a><p>Picks bora za mpira.<br/>Uchambuzi ulio wazi zaidi.</p></div><div><b>Jukwaa</b><a href="#predictions">Picks</a><a href="/results">Matokeo</a><a href="/premium">Premium</a></div><div><b>Kampuni</b><a href="/about">Kuhusu</a><a href="/contact">Mawasiliano</a><a href="/responsible-play">Uwajibikaji</a></div><div><b>Sheria</b><a href="/terms">Masharti</a><a href="/privacy">Faragha</a><a href="/disclaimer">Tahadhari</a></div></div><div class="shell footer-bottom"><span>© 2026 PrimeOdds. Haki zote zimehifadhiwa.</span><span>Imeundwa kusaidia maamuzi yenye maarifa, si kuahidi matokeo.</span></div></footer>
<button aria-label="Back to top" id="backtop">↑</button>


`;

export default function PrimeOddsLanding() {
  useEffect(() => {
