...
const faqs = [
  ...
  ["Premium ina uhakika wa ushindi?", "Hapana. PrimeOdds hutoa uchambuzi na mapendekezo ya michezo, si dhamana ya ushindi. Tunasisitiza matumizi yenye uwajibikaji."],
